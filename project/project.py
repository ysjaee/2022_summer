...
Vcode mode (-v) will make a testbench for the verilog code.
...
def cmd_separator(cmd, prev_cmd, width, charwidth, data, put):		# 한줄의 파형이 끝나면 다음 줄로 ()
	put("|")
...
if __name__ == "__main__":
	...
	parser.add_argument("module_sc", help="TestTarget VerilogHDL source file")
	parser.add_argument("json_sc", help="WaveJSON source file")		# waveJSON source file을 요구
    ...
    parser.add_argument("-v", "--vcode", action="store_true",
		help="generate atestbench by v.code.")
	...
	# parser.add_argument("-v","--vcode", action )
